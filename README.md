...
#### 下载包
```go
go get -u github.com/thomasbacknow/JstSDK
```
#### 如果你的版本太旧了 请及时更新sdk到最新版本
* 1.找到你项目的go.mod文件
* 2.打开找到``github.com/thomasbacknow/JstSDK v0.0.3`` 如要更新版本至 ``github.com/thomasbacknow/JstSDK v0.0.4``
```go 
import (
    ""github.com/thomasbacknow/JstSDK""
)
